            ...
            <div class ="admin-product-form-container">
                <form action="display.php" method="post" enctype="multipart/form-data">
                   ...
                   <!-- <input type="text" placeholder="enter the items name" name="name" class="box">
                    ...
                    <?php inputfields("enter the name of items","name","","text")?>
                    <?php inputfields("enter the price of items","price","","text")?>
                    <!-- <?php inputfields("enter the category of items","category","","text")?> -->
                    ...
                    <div class="form-outline m-0 w-5 m-auto p-100">
                     ...
                     <?php inputfields("enter the quantity of items","quantity","","text")?>
